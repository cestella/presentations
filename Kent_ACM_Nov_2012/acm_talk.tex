...
\item Message Passing Systems
   ...
   \item Con: can be very difficult to maintain, write and understand.  Often designed for massive parallel computers.
   \end{itemize}
\end{itemize}
}
...
\item Limit communication by allowing only a certain set of operations in a flow.\pause
...
\frame{\frametitle{Apache Hadoop -- History}
\begin{itemize}
