...
\begin{itemize}
\item Executing on a sample of size $940$ Positive and Negative documents.
\item Overall Accuracy of $68\%$
\end{itemize}
...
\cline{2-4}
\multirow{2}{*}{Predicted}& Positive & $181$ & $8$ & $189$\\
\cline{2-4}
& Negative & $262$ & $461$ & $723$\\
\cline{2-4}
& Neutral & $20$ & $8$ & $28$\\
\cline{2-4}
\multicolumn{1}{c}{} & \multicolumn{1}{c}{Total} & \multicolumn{1}{c}{$463$} & \multicolumn{1}{c}{$477$} & \multicolumn{1}{c}{$940$}\\
\end{tabular}
}
